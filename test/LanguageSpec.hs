...
readProgTyped :: String -> IO TypedProgram
readProgTyped name = do
  d <- readFile name
  let Right bptp = (parseGaiwan d >>= checkType >>= doBackPropagate)
  return bptp
...
spec = do
  ...
  describe "Language.Gaiwan simple LetB Return" $ do
    ...
    it "does not parse garbage" $
      checkType prog
        `shouldBe` Right (TypedProg (GTransformType (M.fromList [("unbound", GaiwanBuf (GaiwanBufSize 32 1 0) (TVar 42))]) [] [GaiwanBuf (GaiwanBufSize 53 0 33554432) GaiwanInt, GaiwanBuf (GaiwanBufSize 32 1 0) (TVar 42)]) [TLetB (GTransformType (M.fromList [("unbound", GaiwanBuf (GaiwanBufSize 32 1 0) (TVar 42))]) [] [GaiwanBuf (GaiwanBufSize 53 0 33554432) GaiwanInt, GaiwanBuf (GaiwanBufSize 32 1 0) (TVar 42)]) "k" [TIApp (GTransformType M.empty [] [GaiwanBuf (GaiwanBufSize 0 0 33554432) GaiwanInt]) (TAbstraction (GaiwanArrow [] (GTransformType M.empty [] [GaiwanBuf (GaiwanBufSize 0 0 33554432) GaiwanInt])) "fresh" [] [TShaper (GTransformType M.empty [] [GaiwanBuf (GaiwanBufSize 0 0 33554432) GaiwanInt]) "fresh" ["i"] (Var "i" False)]) []] [TReturn (GTransformType (M.fromList [("k", GaiwanBuf (GaiwanBufSize 1 1 0) (TVar 2)), ("unbound", GaiwanBuf (GaiwanBufSize 3 1 0) (TVar 4))]) [] [GaiwanBuf (GaiwanBufSize 1 1 0) (TVar 2), GaiwanBuf (GaiwanBufSize 3 1 0) (TVar 4)]) ["k", "unbound"]]])

  describe "Language.Gaiwan simple LetB Return" $ do
    let prog = Prog [] [LetB "k" [IApp "fresh" True [Int 33554432]] [Return ["k"]]]
    it "Correcty combines" $
      checkType prog
        `shouldBe` Right (TypedProg (GTransformType M.empty [] [GaiwanBuf (GaiwanBufSize 33 0 33554432) GaiwanInt]) [TLetB (GTransformType M.empty [] [GaiwanBuf (GaiwanBufSize 33 0 33554432) GaiwanInt]) "k" [TIApp (GTransformType M.empty [] [GaiwanBuf (GaiwanBufSize 0 0 33554432) GaiwanInt]) (TAbstraction (GaiwanArrow [] (GTransformType M.empty [] [GaiwanBuf (GaiwanBufSize 0 0 33554432) GaiwanInt])) "fresh" [] [TShaper (GTransformType M.empty [] [GaiwanBuf (GaiwanBufSize 0 0 33554432) GaiwanInt]) "fresh" ["i"] (Var "i" False)]) []] [TReturn (GTransformType (M.fromList [("k", GaiwanBuf (GaiwanBufSize 1 1 0) (TVar 2))]) [] [GaiwanBuf (GaiwanBufSize 1 1 0) (TVar 2)]) ["k"]]])

  describe "Language.Gaiwan simple Return" $ do
    let prog = Prog [] [Return ["k"]]
    it "Simple return" $
      checkType prog
        `shouldBe` Right (TypedProg (GTransformType (M.fromList [("k", GaiwanBuf (GaiwanBufSize 0 1 0) (TVar 1))]) [] [GaiwanBuf (GaiwanBufSize 0 1 0) (TVar 1)]) [TReturn (GTransformType (M.fromList [("k", GaiwanBuf (GaiwanBufSize 0 1 0) (TVar 1))]) [] [GaiwanBuf (GaiwanBufSize 0 1 0) (TVar 1)]) ["k"]])

    let prog = Prog [] [Return ["a", "b"]]
    it "Simple return of two" $
      checkType prog
        `shouldBe` Right (TypedProg (GTransformType (M.fromList [("a", GaiwanBuf (GaiwanBufSize 0 1 0) (TVar 1)), ("b", GaiwanBuf (GaiwanBufSize 2 1 0) (TVar 3))]) [] [GaiwanBuf (GaiwanBufSize 0 1 0) (TVar 1), GaiwanBuf (GaiwanBufSize 2 1 0) (TVar 3)]) [TReturn (GTransformType (M.fromList [("a", GaiwanBuf (GaiwanBufSize 0 1 0) (TVar 1)), ("b", GaiwanBuf (GaiwanBufSize 2 1 0) (TVar 3))]) [] [GaiwanBuf (GaiwanBufSize 0 1 0) (TVar 1), GaiwanBuf (GaiwanBufSize 2 1 0) (TVar 3)]) ["a", "b"]])
    ...
    do
      ...
      it "types a sort.t program correcty" $
        checkDefsType expectedProg
          `shouldBe` Right [TAbstraction (GaiwanArrow [GaiwanInt, GaiwanInt] (GTransformType (M.fromList []) [GaiwanBuf (GaiwanBufSize 73 2 0) GaiwanInt] [GaiwanBuf (GaiwanBufSize 73 2 0) GaiwanInt])) "bitonic_select" ["round", "arrPerBlock"] [TShaper (GTransformType (M.fromList []) [GaiwanBuf (GaiwanBufSize 1 2 0) (TVar 0)] [GaiwanBuf (GaiwanBufSize 1 1 0) (GaiwanTuple [TVar 0, TVar 0])]) "split" ["i", "d"] (Let "blockid" (Div (Var "i" False) (Var "arrPerBlock" False)) (Let "blockstart" (Times (Times (Var "blockid" False) (Var "arrPerBlock" False)) (Int 2)) (Let "blockoffset" (Modulo (Var "i" False) (Var "arrPerBlock" False)) (Let "pos" (Plus (Var "blockstart" False) (Var "blockoffset" False)) (Tuple [ArrayGet (Var "d" False) (Var "pos" False), ArrayGet (Var "d" False) (Plus (Var "pos" False) (Var "arrPerBlock" False))]))))), TMapper (GTransformType (M.fromList []) [GaiwanBuf (GaiwanBufSize 5 1 0) (GaiwanTuple [GaiwanInt, GaiwanInt])] [GaiwanBuf (GaiwanBufSize 5 1 0) (GaiwanTuple [GaiwanInt, GaiwanInt])]) "bitonic_select_impl" ["i", "a"] (If (IsGreater (Modulo (Var "i" False) (Pow (Int 2) (Plus (Var "round" False) (Int 1)))) (Pow (Int 2) (Var "round" False))) (If (IsGreater (Select (Var "a" False) 0) (Select (Var "a" False) 1)) (Var "a" False) (Tuple [Select (Var "a" False) 1, Select (Var "a" False) 0])) (If (IsGreater (Select (Var "a" False) 0) (Select (Var "a" False) 1)) (Tuple [Select (Var "a" False) 1, Select (Var "a" False) 0]) (Var "a" False))), TShaper (GTransformType (M.fromList []) [GaiwanBuf (GaiwanBufSize 3 1 0) (GaiwanTuple [TVar 2, TVar 2])] [GaiwanBuf (GaiwanBufSize 3 2 0) (TVar 2)]) "join" ["i", "d"] (Let "arrowBlock" (Div (Var "i" False) (Times (Int 2) (Var "arrPerBlock" False))) (Let "arrowBlockStart" (Times (Var "arrowBlock" False) (Var "arrPerBlock" False)) (Let "arrowOffset" (Modulo (Var "i" False) (Var "arrPerBlock" False)) (If (IsGreater (Plus (Times (Var "arrowBlockStart" False) (Int 2)) (Var "arrPerBlock" False)) (Plus (Var "i" False) (Int 1))) (Select (ArrayGet (Var "d" False) (Plus (Var "arrowBlockStart" False) (Var "arrowOffset" False))) 0) (Select (ArrayGet (Var "d" False) (Plus (Var "arrowBlockStart" False) (Var "arrowOffset" False))) 1)))))], TAbstraction (GaiwanArrow [] (GTransformType (M.fromList []) [] [GaiwanBuf (GaiwanBufSize 4 0 33554432) GaiwanInt])) "randomizer" [] [TShaper (GTransformType (M.fromList []) [] [GaiwanBuf (GaiwanBufSize 4 0 33554432) GaiwanInt]) "randomizer" ["i"] (Modulo (Times (Var "i" False) (Int 593)) (Int 1000))]]

      let expectedTypedProg = (TypedProg (GTransformType (M.fromList []) [] [GaiwanBuf (GaiwanBufSize 83 0 33554432) GaiwanInt]) [TIApp (GTransformType (M.fromList []) [] [GaiwanBuf (GaiwanBufSize 4 0 33554432) GaiwanInt]) (TAbstraction (GaiwanArrow [] (GTransformType (M.fromList []) [] [GaiwanBuf (GaiwanBufSize 4 0 33554432) GaiwanInt])) "randomizer" [] [TShaper (GTransformType (M.fromList []) [] [GaiwanBuf (GaiwanBufSize 4 0 33554432) GaiwanInt]) "randomizer" ["i"] (Modulo (Times (Var "i" False) (Int 593)) (Int 1000))]) [], TLoop (GTransformType (M.fromList []) [GaiwanBuf (GaiwanBufSize 73 2 0) GaiwanInt] [GaiwanBuf (GaiwanBufSize 73 2 0) GaiwanInt]) (Int 25) "round" [TLoop (GTransformType (M.fromList []) [GaiwanBuf (GaiwanBufSize 73 2 0) GaiwanInt] [GaiwanBuf (GaiwanBufSize 73 2 0) GaiwanInt]) (Plus (Var "round" False) (Int 1)) "step" [TIApp (GTransformType (M.fromList []) [GaiwanBuf (GaiwanBufSize 73 2 0) GaiwanInt] [GaiwanBuf (GaiwanBufSize 73 2 0) GaiwanInt]) (TAbstraction (GaiwanArrow [GaiwanInt, GaiwanInt] (GTransformType (M.fromList []) [GaiwanBuf (GaiwanBufSize 73 2 0) GaiwanInt] [GaiwanBuf (GaiwanBufSize 73 2 0) GaiwanInt])) "bitonic_select" ["round", "arrPerBlock"] [TShaper (GTransformType (M.fromList []) [GaiwanBuf (GaiwanBufSize 1 2 0) (TVar 0)] [GaiwanBuf (GaiwanBufSize 1 1 0) (GaiwanTuple [TVar 0, TVar 0])]) "split" ["i", "d"] (Let "blockid" (Div (Var "i" False) (Var "arrPerBlock" False)) (Let "blockstart" (Times (Times (Var "blockid" False) (Var "arrPerBlock" False)) (Int 2)) (Let "blockoffset" (Modulo (Var "i" False) (Var "arrPerBlock" False)) (Let "pos" (Plus (Var "blockstart" False) (Var "blockoffset" False)) (Tuple [ArrayGet (Var "d" False) (Var "pos" False), ArrayGet (Var "d" False) (Plus (Var "pos" False) (Var "arrPerBlock" False))]))))), TMapper (GTransformType (M.fromList []) [GaiwanBuf (GaiwanBufSize 5 1 0) (GaiwanTuple [GaiwanInt, GaiwanInt])] [GaiwanBuf (GaiwanBufSize 5 1 0) (GaiwanTuple [GaiwanInt, GaiwanInt])]) "bitonic_select_impl" ["i", "a"] (If (IsGreater (Modulo (Var "i" False) (Pow (Int 2) (Plus (Var "round" False) (Int 1)))) (Pow (Int 2) (Var "round" False))) (If (IsGreater (Select (Var "a" False) 0) (Select (Var "a" False) 1)) (Var "a" False) (Tuple [Select (Var "a" False) 1, Select (Var "a" False) 0])) (If (IsGreater (Select (Var "a" False) 0) (Select (Var "a" False) 1)) (Tuple [Select (Var "a" False) 1, Select (Var "a" False) 0]) (Var "a" False))), TShaper (GTransformType (M.fromList []) [GaiwanBuf (GaiwanBufSize 3 1 0) (GaiwanTuple [TVar 2, TVar 2])] [GaiwanBuf (GaiwanBufSize 3 2 0) (TVar 2)]) "join" ["i", "d"] (Let "arrowBlock" (Div (Var "i" False) (Times (Int 2) (Var "arrPerBlock" False))) (Let "arrowBlockStart" (Times (Var "arrowBlock" False) (Var "arrPerBlock" False)) (Let "arrowOffset" (Modulo (Var "i" False) (Var "arrPerBlock" False)) (If (IsGreater (Plus (Times (Var "arrowBlockStart" False) (Int 2)) (Var "arrPerBlock" False)) (Plus (Var "i" False) (Int 1))) (Select (ArrayGet (Var "d" False) (Plus (Var "arrowBlockStart" False) (Var "arrowOffset" False))) 0) (Select (ArrayGet (Var "d" False) (Plus (Var "arrowBlockStart" False) (Var "arrowOffset" False))) 1)))))]) [Var "round" False, Pow (Int 2) (Minus (Var "round" False) (Var "step" False))]]]])
      ...
      it "backpropagates types a sort.t program correcty" $
        doBackPropagate expectedTypedProg
          `shouldBe` Right (TypedProg (GTransformType (M.fromList []) [] [GaiwanBuf (GaiwanBufSize 83 0 33554432) GaiwanInt]) [TIApp (GTransformType (M.fromList []) [] [GaiwanBuf (GaiwanBufSize 4 0 33554432) GaiwanInt]) (TAbstraction (GaiwanArrow [] (GTransformType (M.fromList []) [] [GaiwanBuf (GaiwanBufSize 4 0 33554432) GaiwanInt])) "randomizer" [] [TShaper (GTransformType (M.fromList []) [] [GaiwanBuf (GaiwanBufSize 4 0 33554432) GaiwanInt]) "randomizer" ["i"] (Modulo (Times (Var "i" False) (Int 593)) (Int 1000))]) [], TLoop (GTransformType (M.fromList []) [GaiwanBuf (GaiwanBufSize 4 0 33554432) GaiwanInt] [GaiwanBuf (GaiwanBufSize 4 0 33554432) GaiwanInt]) (Int 25) "round" [TLoop (GTransformType (M.fromList []) [GaiwanBuf (GaiwanBufSize 4 0 33554432) GaiwanInt] [GaiwanBuf (GaiwanBufSize 4 0 33554432) GaiwanInt]) (Plus (Var "round" False) (Int 1)) "step" [TIApp (GTransformType (M.fromList []) [GaiwanBuf (GaiwanBufSize 4 0 33554432) GaiwanInt] [GaiwanBuf (GaiwanBufSize 4 0 33554432) GaiwanInt]) (TAbstraction (GaiwanArrow [GaiwanInt, GaiwanInt] (GTransformType (M.fromList []) [GaiwanBuf (GaiwanBufSize 4 0 33554432) GaiwanInt] [GaiwanBuf (GaiwanBufSize 4 0 33554432) GaiwanInt])) "bitonic_select" ["round", "arrPerBlock"] [TShaper (GTransformType (M.fromList []) [GaiwanBuf (GaiwanBufSize 4 0 33554432) GaiwanInt] [GaiwanBuf (GaiwanBufSize 4 0 16777216) (GaiwanTuple [GaiwanInt, GaiwanInt])]) "split" ["i", "d"] (Let "blockid" (Div (Var "i" False) (Var "arrPerBlock" False)) (Let "blockstart" (Times (Times (Var "blockid" False) (Var "arrPerBlock" False)) (Int 2)) (Let "blockoffset" (Modulo (Var "i" False) (Var "arrPerBlock" False)) (Let "pos" (Plus (Var "blockstart" False) (Var "blockoffset" False)) (Tuple [ArrayGet (Var "d" False) (Var "pos" False), ArrayGet (Var "d" False) (Plus (Var "pos" False) (Var "arrPerBlock" False))]))))), TMapper (GTransformType (M.fromList []) [GaiwanBuf (GaiwanBufSize 4 0 16777216) (GaiwanTuple [GaiwanInt, GaiwanInt])] [GaiwanBuf (GaiwanBufSize 4 0 16777216) (GaiwanTuple [GaiwanInt, GaiwanInt])]) "bitonic_select_impl" ["i", "a"] (If (IsGreater (Modulo (Var "i" False) (Pow (Int 2) (Plus (Var "round" False) (Int 1)))) (Pow (Int 2) (Var "round" False))) (If (IsGreater (Select (Var "a" False) 0) (Select (Var "a" False) 1)) (Var "a" False) (Tuple [Select (Var "a" False) 1, Select (Var "a" False) 0])) (If (IsGreater (Select (Var "a" False) 0) (Select (Var "a" False) 1)) (Tuple [Select (Var "a" False) 1, Select (Var "a" False) 0]) (Var "a" False))), TShaper (GTransformType (M.fromList []) [GaiwanBuf (GaiwanBufSize 4 0 16777216) (GaiwanTuple [GaiwanInt, GaiwanInt])] [GaiwanBuf (GaiwanBufSize 4 0 33554432) GaiwanInt]) "join" ["i", "d"] (Let "arrowBlock" (Div (Var "i" False) (Times (Int 2) (Var "arrPerBlock" False))) (Let "arrowBlockStart" (Times (Var "arrowBlock" False) (Var "arrPerBlock" False)) (Let "arrowOffset" (Modulo (Var "i" False) (Var "arrPerBlock" False)) (If (IsGreater (Plus (Times (Var "arrowBlockStart" False) (Int 2)) (Var "arrPerBlock" False)) (Plus (Var "i" False) (Int 1))) (Select (ArrayGet (Var "d" False) (Plus (Var "arrowBlockStart" False) (Var "arrowOffset" False))) 0) (Select (ArrayGet (Var "d" False) (Plus (Var "arrowBlockStart" False) (Var "arrowOffset" False))) 1)))))]) [Var "round" False, Pow (Int 2) (Minus (Var "round" False) (Var "step" False))]]]])
      let expectedInputSort =
            ( Prog
                [Abstraction Nothing "bitonic_select" [("round", Just (AShape GaiwanInt)), ("arrPerBlock", Just (AShape GaiwanInt))] [Shaper (Just (ABuf (GaiwanBuf (GaiwanBufSize "n" 1 0) (GaiwanTuple [TVar "C", TVar "C"])))) "split" [("i", Nothing), ("d", Just (ABuf (GaiwanBuf (GaiwanBufSize "n" 2 0) (TVar "C"))))] (Let "blockid" (Div (Var "i" False) (Var "arrPerBlock" False)) (Let "blockstart" (Times (Times (Var "blockid" False) (Var "arrPerBlock" False)) (Int 2)) (Let "blockoffset" (Modulo (Var "i" False) (Var "arrPerBlock" False)) (Let "pos" (Plus (Var "blockstart" False) (Var "blockoffset" False)) (Tuple [ArrayGet (Var "d" False) (Var "pos" False), ArrayGet (Var "d" False) (Plus (Var "pos" False) (Var "arrPerBlock" False))]))))), Mapper (Just (AShape (GaiwanTuple [GaiwanInt, GaiwanInt]))) "bitonic_select_impl" [("i", Nothing), ("a", Just (AShape (GaiwanTuple [GaiwanInt, GaiwanInt])))] (If (IsGreater (Modulo (Var "i" False) (Pow (Int 2) (Plus (Var "round" False) (Int 1)))) (Pow (Int 2) (Var "round" False))) (If (IsGreater (Select (Var "a" False) 0) (Select (Var "a" False) 1)) (Var "a" False) (Tuple [Select (Var "a" False) 1, Select (Var "a" False) 0])) (If (IsGreater (Select (Var "a" False) 0) (Select (Var "a" False) 1)) (Tuple [Select (Var "a" False) 1, Select (Var "a" False) 0]) (Var "a" False))), Shaper (Just (ABuf (GaiwanBuf (GaiwanBufSize "n" 2 0) (TVar "B")))) "join" [("i", Nothing), ("d", Just (ABuf (GaiwanBuf (GaiwanBufSize "n" 1 0) (GaiwanTuple [TVar "B", TVar "B"]))))] (Let "arrowBlock" (Div (Var "i" False) (Times (Int 2) (Var "arrPerBlock" False))) (Let "arrowBlockStart" (Times (Var "arrowBlock" False) (Var "arrPerBlock" False)) (Let "arrowOffset" (Modulo (Var "i" False) (Var "arrPerBlock" False)) (If (IsGreater (Plus (Times (Var "arrowBlockStart" False) (Int 2)) (Var "arrPerBlock" False)) (Plus (Var "i" False) (Int 1))) (Select (ArrayGet (Var "d" False) (Plus (Var "arrowBlockStart" False) (Var "arrowOffset" False))) 0) (Select (ArrayGet (Var "d" False) (Plus (Var "arrowBlockStart" False) (Var "arrowOffset" False))) 1)))))]]
                [Return ["size33554432"], Loop (Int 25) "round" [Loop (Plus (Var "round" False) (Int 1)) "step" [IApp "bitonic_select" False [Var "round" False, Pow (Int 2) (Minus (Var "round" False) (Var "step" False))]]]]
            )
      ...
      it "types a sort-input.t program correcty" $
        ((checkType expectedInputSort) >>= doBackPropagate)
          `shouldBe` Right
            ( TypedProg
                (GTransformType (M.fromList [("size33554432", GaiwanBuf (GaiwanBufSize 93 2 0) GaiwanInt)]) [] [GaiwanBuf (GaiwanBufSize 93 2 0) GaiwanInt])
                [ TReturn (GTransformType (M.fromList [("size33554432", GaiwanBuf (GaiwanBufSize 93 2 0) GaiwanInt)]) [] [GaiwanBuf (GaiwanBufSize 93 2 0) GaiwanInt]) ["size33554432"],
                  TLoop
                    (GTransformType (M.fromList [("size33554432", GaiwanBuf (GaiwanBufSize 93 2 0) GaiwanInt)]) [GaiwanBuf (GaiwanBufSize 93 2 0) GaiwanInt] [GaiwanBuf (GaiwanBufSize 93 2 0) GaiwanInt])
                    (Int 25)
                    "round"
                    [ TLoop
                        (GTransformType (M.fromList [("size33554432", GaiwanBuf (GaiwanBufSize 93 2 0) GaiwanInt)]) [GaiwanBuf (GaiwanBufSize 93 2 0) GaiwanInt] [GaiwanBuf (GaiwanBufSize 93 2 0) GaiwanInt])
                        ...
                        [ TIApp
                            (GTransformType (M.fromList [("size33554432", GaiwanBuf (GaiwanBufSize 93 2 0) GaiwanInt)]) [GaiwanBuf (GaiwanBufSize 93 2 0) GaiwanInt] [GaiwanBuf (GaiwanBufSize 93 2 0) GaiwanInt])
                            ( TAbstraction
                                (GaiwanArrow [GaiwanInt, GaiwanInt] (GTransformType (M.fromList []) [GaiwanBuf (GaiwanBufSize 93 2 0) GaiwanInt] [GaiwanBuf (GaiwanBufSize 93 2 0) GaiwanInt]))
                                "bitonic_select"
                                ["round", "arrPerBlock"]
                                [ TShaper
                                    (GTransformType (M.fromList []) [GaiwanBuf (GaiwanBufSize 93 2 0) GaiwanInt] [GaiwanBuf (GaiwanBufSize 93 1 0) (GaiwanTuple [GaiwanInt, GaiwanInt])])
                                    "split"
                                    ["i", "d"]
                                    ( Let
                                        "blockid"
                                        (Div (Var "i" False) (Var "arrPerBlock" False))
                                        ( Let
                                            "blockstart"
                                            (Times (Times (Var "blockid" False) (Var "arrPerBlock" False)) (Int 2))
                                            ( Let
                                                "blockoffset"
                                                (Modulo (Var "i" False) (Var "arrPerBlock" False))
                                                ( Let
                                                    "pos"
                                                    (Plus (Var "blockstart" False) (Var "blockoffset" False))
                                                    ( Tuple
                                                        [ ArrayGet (Var "d" False) (Var "pos" False),
                                                          ArrayGet (Var "d" False) (Plus (Var "pos" False) (Var "arrPerBlock" False))
                                                        ]
                                                    )
                                                )
                                            )
                                  ...
                                  TMapper (GTransformType (M.fromList []) [GaiwanBuf (GaiwanBufSize 93 1 0) (GaiwanTuple [GaiwanInt, GaiwanInt])] [GaiwanBuf (GaiwanBufSize 93 1 0) (GaiwanTuple [GaiwanInt, GaiwanInt])]) "bitonic_select_impl" ["i", "a"] (If (IsGreater (Modulo (Var "i" False) (Pow (Int 2) (Plus (Var "round" False) (Int 1)))) (Pow (Int 2) (Var "round" False))) (If (IsGreater (Select (Var "a" False) 0) (Select (Var "a" False) 1)) (Var "a" False) (Tuple [Select (Var "a" False) 1, Select (Var "a" False) 0])) (If (IsGreater (Select (Var "a" False) 0) (Select (Var "a" False) 1)) (Tuple [Select (Var "a" False) 1, Select (Var "a" False) 0]) (Var "a" False))),
                                  TShaper (GTransformType (M.fromList []) [GaiwanBuf (GaiwanBufSize 93 1 0) (GaiwanTuple [GaiwanInt, GaiwanInt])] [GaiwanBuf (GaiwanBufSize 93 2 0) GaiwanInt]) "join" ["i", "d"] (Let "arrowBlock" (Div (Var "i" False) (Times (Int 2) (Var "arrPerBlock" False))) (Let "arrowBlockStart" (Times (Var "arrowBlock" False) (Var "arrPerBlock" False)) (Let "arrowOffset" (Modulo (Var "i" False) (Var "arrPerBlock" False)) (If (IsGreater (Plus (Times (Var "arrowBlockStart" False) (Int 2)) (Var "arrPerBlock" False)) (Plus (Var "i" False) (Int 1))) (Select (ArrayGet (Var "d" False) (Plus (Var "arrowBlockStart" False) (Var "arrowOffset" False))) 0) (Select (ArrayGet (Var "d" False) (Plus (Var "arrowBlockStart" False) (Var "arrowOffset" False))) 1)))))
                                ]
                            )
      ...
      it "plans a simple-mapper-reducer.t program correcty" $ do
        ...
        tail (makePlan bptp)
          `shouldBe` [ AllocBuffer (ReservedBuffer (GPUBufferName 2) (GaiwanBuf (GaiwanBufSize 63 0 1) GaiwanInt)),
