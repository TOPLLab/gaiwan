...
--        `shouldBe` Right (TypedProg (GTransformType M.empty [] [GaiwanBuf (GaiwanBufSize 3 0 33554432) GaiwanInt]) [TIApp (GTransformType M.empty [] [GaiwanBuf (GaiwanBufSize 3 0 33554432) GaiwanInt]) (TAbstraction (GaiwanArrow [] (GTransformType M.empty [] [GaiwanBuf (GaiwanBufSize 3 0 33554432) GaiwanInt])) "fresh" [] [TShaper (GTransformType M.empty [] [GaiwanBuf (GaiwanBufSize 3 0 33554432) GaiwanInt]) "fresh" ["i"] (Var "i" False)]) [], TIApp (GTransformType M.empty [GaiwanBuf (GaiwanBufSize 3 1337 1337) (TVar 5)] [GaiwanBuf (GaiwanBufSize 3 1337 1337) GaiwanInt]) (TAbstraction (GaiwanArrow [] (GTransformType M.empty [GaiwanBuf (GaiwanBufSize 3 1337 1337) (TVar 2)] [GaiwanBuf (GaiwanBufSize 3 1337 1337) GaiwanInt])) "randomizer" [] [TShaper (GTransformType M.empty [GaiwanBuf (GaiwanBufSize 3 1337 1337) (TVar 2)] [GaiwanBuf (GaiwanBufSize 3 1337 1337) GaiwanInt]) "randomizer" ["i", "lol"] (Modulo (Times (Var "i" False) (Int 593)) (Int 1000))]) [], TLoop (GTransformType M.empty [GaiwanBuf (GaiwanBufSize 3 2 0) GaiwanInt] [GaiwanBuf (GaiwanBufSize 3 2 0) GaiwanInt]) (Int 25) "round" [TLoop (GTransformType M.empty [GaiwanBuf (GaiwanBufSize 3 2 0) GaiwanInt] [GaiwanBuf (GaiwanBufSize 3 2 0) GaiwanInt]) (Plus (Var "round" False) (Int 1)) "step" [TIApp (GTransformType M.empty [GaiwanBuf (GaiwanBufSize 3 2 0) GaiwanInt] [GaiwanBuf (GaiwanBufSize 3 2 0) GaiwanInt]) (TAbstraction (GaiwanArrow [GaiwanInt, GaiwanInt] (GTransformType M.empty [GaiwanBuf (GaiwanBufSize 3 2 0) GaiwanInt] [GaiwanBuf (GaiwanBufSize 3 2 0) GaiwanInt])) "bitonic_select" ["round", "arrPerBlock"] [TShaper (GTransformType M.empty [GaiwanBuf (GaiwanBufSize 3 2 0) (TVar 0)] [GaiwanBuf (GaiwanBufSize 3 1337 1337) (GaiwanTuple [TVar 0, TVar 0])]) "split" ["i", "d"] (Let "blockid" (Div (Var "i" False) (Var "arrPerBlock" False)) (Let "blockstart" (Times (Times (Var "blockid" False) (Var "arrPerBlock" False)) (Int 2)) (Let "blockoffset" (Modulo (Var "i" False) (Var "arrPerBlock" False)) (Let "pos" (Plus (Var "blockstart" False) (Var "blockoffset" False)) (Tuple [ArrayGet (Var "d" False) (Var "pos" False), ArrayGet (Var "d" False) (Plus (Var "pos" False) (Var "arrPerBlock" False))]))))), TMapper (GTransformType M.empty [GaiwanBuf (GaiwanBufSize 3 1337 1337) (GaiwanTuple [GaiwanInt, GaiwanInt])] [GaiwanBuf (GaiwanBufSize 3 1337 1337) (GaiwanTuple [GaiwanInt, GaiwanInt])]) "bitonic_select_impl" ["i", "a"] (If (IsGreater (Modulo (Var "i" False) (Pow (Int 2) (Plus (Var "round" False) (Int 1)))) (Pow (Int 2) (Var "round" False))) (If (IsGreater (Select (Var "a" False) 0) (Select (Var "a" False) 1)) (Var "a" False) (Tuple [Select (Var "a" False) 1, Select (Var "a" False) 0])) (If (IsGreater (Select (Var "a" False) 0) (Select (Var "a" False) 1)) (Tuple [Select (Var "a" False) 1, Select (Var "a" False) 0]) (Var "a" False))), TShaper (GTransformType M.empty [GaiwanBuf (GaiwanBufSize 3 1337 1337) (GaiwanTuple [TVar 1, TVar 1])] [GaiwanBuf (GaiwanBufSize 3 2 0) (TVar 1)]) "join" ["i", "d"] (Let "arrowBlock" (Div (Var "i" False) (Times (Int 2) (Var "arrPerBlock" False))) (Let "arrowBlockStart" (Times (Var "arrowBlock" False) (Var "arrPerBlock" False)) (Let "arrowOffset" (Modulo (Var "i" False) (Var "arrPerBlock" False)) (Let "arrow" (ArrayGet (Var "d" False) (Plus (Times (Var "arrowBlock" False) (Var "arrPerBlock" False)) (Var "arrowOffset" False))) (If (IsGreater (Plus (Times (Var "arrowBlockStart" False) (Int 2)) (Var "arrPerBlock" False)) (Var "i" False)) (Select (Var "arrow" False) 0) (Select (Var "arrow" False) 1))))))]) [Var "round" False, Pow (Int 2) (Minus (Var "round" False) (Var "step" False))]]]])
